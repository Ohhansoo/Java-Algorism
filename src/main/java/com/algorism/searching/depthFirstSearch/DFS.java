...
public class DFS {
    public static void main(String[] args) throws IOException {
      ...
      //  myAnswer.countConnectedComponent();
        ...
        //              7333
        //              7393
        System.out.println("문제 2(05-1-024) : 신기한 소수 찾기");
       // myAnswer.findAmazingPrimeNumber();

        //문제 3(05-1-025) : 친구 관계 파악하기
        /************************************** 개 요 *************************************
         * 총 N명이 참가하고 있는 프로그램이 있다.
         * 사람들은 0번부터 N-1번으로 번호가 매겨지 있고 일부 사람들은 친구다.
         * A > B > C > D 친구 관계가 존재하는지 여부를 구하는 프로그램을 작성하라
         * */
        //입력 : 1번째 줄에 사람의 수 N(5 <= N <= 2,000)과 친구 관계의 수 M(1 <= M <= 2,000)
        //      2번째 줄부터 M개의 줄에 정수 a와 b가 주어진다.
        //      a와 b는 친구라는 뜻이다(0 <= a,b <= N-1, a != b), 같은 친구 관계가 2번이상 주어지지 않는다.
        //출력 : 문제의 조건에 맞는 A, B, C, D, E가 존재할 때 1이 없으면 0을 출력한다.
        //[예제 입력1] : 8 8 //사람의 수, 친구 관계의 수
        //              1 7
        //              3 7
        //              4 7
        //              3 4
        ...
        //              2 7
        //[예제 출력1] : 1
        System.out.println("문제 3(05-1-025) : 친구 관계 파악하기");
        myAnswer.findFriend();
    }
