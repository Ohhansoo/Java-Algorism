...
public class BinarySearch {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //문제 3(05-3-031) : 배열에서 K번째 수 찾기
        /************************************** 개 요 *************************************
         * 세준이는 크기가 N*N인 배열을 만들었다. 배열에 들어 있는 수는 A[i][j] = i * j이다.
         * 이 수를 1차원 배열 B에 넣으면 B의 크기는 N * N이 된다. B를 오름차순 정렬했을 떄 B[k]를 구하여라.
         * 배열 A와 B의 인덱스는 1부터 시작한다.
         * */
        //입력 : 1번째 줄에 배열의 크기 N이 주어진다. N은 10^5보다 작거나 같은 자연수다.
